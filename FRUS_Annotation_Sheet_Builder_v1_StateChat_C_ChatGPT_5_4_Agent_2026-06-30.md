...
```json
{
  ...
  "document_assessment": {
    ...
    "model": "gpt-5.4",
    "run_mode": "pdf_to_annotation_sheet | batch_pdf_to_annotation_sheet | source_note_only | heading_and_metadata_only | attachment_triage | volume_or_chapter_packet_triage | source_register_triage | publication_placeholder_triage | legacy_digitized_triage | web_print_export_triage | ocr_triage | docx_production",
