...
function parseArgs(argv) {
  ...
  for (let index = 2; index < argv.length; index += 1) {
    ...
    if (arg === "--docx") {
      ...
      index += 1;
    } else if (arg === "--document-status-lifecycle-registry") {
      documentStatusLifecycleRegistryPath = argv[index + 1];
      index += 1;
...
function buildAudit({ options, artifacts, steps, reports }) {
  ...
  const editorialMethodAudit = reports.editorial_method_usage_audit || null;
  ...
  const meetingAttendanceAudit = reports.meeting_attendance_usage_audit || null;
  const timeZoneAudit = reports.time_zone_usage_audit || null;
  const summitPublicEventAudit = reports.summit_public_event_usage_audit || null;
  ...
  const releaseApparatusAudit = reports.release_apparatus_usage_audit || null;
  ...
  const congressionalLegalAudit = reports.congressional_legal_usage_audit || null;
  const economicFinancialAudit = reports.economic_financial_usage_audit || null;
  const militaryCrisisAudit = reports.military_crisis_usage_audit || null;
  const intelligenceLawEnforcementAudit = reports.intelligence_law_enforcement_usage_audit || null;
  const humanRightsRefugeeGlobalIssuesAudit = reports.human_rights_refugee_global_issues_usage_audit || null;
  const footnoteReferbackAudit = reports.footnote_referback_usage_audit || null;
  const crossReferenceAudit = reports.cross_reference_usage_audit || null;
  ...
  return {
    ...
    counts: {
      ...
      source_note_lint_direct_edit_conflicts: sourceNoteLint?.summary?.direct_edit_conflicts || 0,
      ...
      source_surrogate_unmatched_like_units:
        sourceSurrogateAudit?.summary?.unmatched_source_surrogate_like_units || 0,
      source_surrogate_source_copy_basis_warnings:
        sourceSurrogateAudit?.summary?.source_copy_basis_warnings || 0,
      source_surrogate_direct_edit_conflicts:
        sourceSurrogateAudit?.summary?.direct_source_surrogate_edit_conflicts || 0,
      document_status_lifecycle_registry_usages:
        documentStatusLifecycleAudit?.summary?.document_status_lifecycle_usages || 0,
      document_status_lifecycle_registry_warnings: documentStatusLifecycleAudit?.summary?.warnings || 0,
      document_status_lifecycle_unmatched_like_units:
        documentStatusLifecycleAudit?.summary?.unmatched_document_status_like_units || 0,
      document_status_lifecycle_direct_edit_conflicts:
        documentStatusLifecycleAudit?.summary?.direct_document_status_lifecycle_edit_conflicts || 0,
      ...
      document_metadata_component_gaps: documentMetadataAudit?.summary?.metadata_component_gaps || 0,
      ...
      editorial_method_registry_usages: editorialMethodAudit?.summary?.editorial_method_usages || 0,
      editorial_method_registry_warnings: editorialMethodAudit?.summary?.warnings || 0,
      editorial_method_unmatched_like_units:
        editorialMethodAudit?.summary?.unmatched_editorial_method_like_units || 0,
      editorial_method_direct_edit_conflicts:
        editorialMethodAudit?.summary?.direct_editorial_method_edit_conflicts || 0,
      ...
      meeting_attendance_registry_usages: meetingAttendanceAudit?.summary?.meeting_attendance_usages || 0,
      meeting_attendance_registry_warnings: meetingAttendanceAudit?.summary?.warnings || 0,
      meeting_attendance_unmatched_like_units:
        meetingAttendanceAudit?.summary?.unmatched_meeting_attendance_like_units || 0,
      meeting_attendance_direct_edit_conflicts:
        meetingAttendanceAudit?.summary?.direct_meeting_attendance_edit_conflicts || 0,
      ...
      summit_public_event_registry_usages: summitPublicEventAudit?.summary?.summit_public_event_usages || 0,
      summit_public_event_registry_warnings: summitPublicEventAudit?.summary?.warnings || 0,
      summit_public_event_unmatched_like_units:
        summitPublicEventAudit?.summary?.unmatched_summit_public_event_like_units || 0,
      summit_public_event_direct_edit_conflicts:
        summitPublicEventAudit?.summary?.direct_summit_public_event_edit_conflicts || 0,
      ...
      release_apparatus_registry_usages: releaseApparatusAudit?.summary?.release_apparatus_usages || 0,
      release_apparatus_registry_warnings: releaseApparatusAudit?.summary?.warnings || 0,
      release_apparatus_unmatched_like_units:
        releaseApparatusAudit?.summary?.unmatched_release_apparatus_like_units || 0,
      release_apparatus_direct_edit_conflicts:
        releaseApparatusAudit?.summary?.direct_release_apparatus_edit_conflicts || 0,
      ...
      congressional_legal_registry_usages: congressionalLegalAudit?.summary?.congressional_legal_usages || 0,
      congressional_legal_registry_warnings: congressionalLegalAudit?.summary?.warnings || 0,
      congressional_legal_unmatched_like_units:
        congressionalLegalAudit?.summary?.unmatched_congressional_legal_like_units || 0,
      congressional_legal_direct_edit_conflicts:
        congressionalLegalAudit?.summary?.direct_congressional_legal_edit_conflicts || 0,
      economic_financial_registry_usages: economicFinancialAudit?.summary?.economic_financial_usages || 0,
      economic_financial_registry_warnings: economicFinancialAudit?.summary?.warnings || 0,
      economic_financial_unmatched_like_units:
        economicFinancialAudit?.summary?.unmatched_economic_financial_like_units || 0,
      economic_financial_direct_edit_conflicts:
        economicFinancialAudit?.summary?.direct_economic_financial_edit_conflicts || 0,
      military_crisis_registry_usages: militaryCrisisAudit?.summary?.military_crisis_usages || 0,
      military_crisis_registry_warnings: militaryCrisisAudit?.summary?.warnings || 0,
      military_crisis_unmatched_like_units:
        militaryCrisisAudit?.summary?.unmatched_military_crisis_like_units || 0,
      military_crisis_direct_edit_conflicts:
        militaryCrisisAudit?.summary?.direct_military_crisis_edit_conflicts || 0,
      intelligence_law_enforcement_registry_usages:
        intelligenceLawEnforcementAudit?.summary?.intelligence_law_enforcement_usages || 0,
      intelligence_law_enforcement_registry_warnings:
        intelligenceLawEnforcementAudit?.summary?.warnings || 0,
      intelligence_law_enforcement_unmatched_like_units:
        intelligenceLawEnforcementAudit?.summary?.unmatched_intelligence_law_enforcement_like_units || 0,
      intelligence_law_enforcement_direct_edit_conflicts:
        intelligenceLawEnforcementAudit?.summary?.direct_intelligence_law_enforcement_edit_conflicts || 0,
      human_rights_refugee_global_issues_registry_usages:
        humanRightsRefugeeGlobalIssuesAudit?.summary?.human_rights_refugee_global_issues_usages || 0,
      human_rights_refugee_global_issues_registry_warnings:
        humanRightsRefugeeGlobalIssuesAudit?.summary?.warnings || 0,
      human_rights_refugee_global_issues_unmatched_like_units:
        humanRightsRefugeeGlobalIssuesAudit?.summary?.unmatched_human_rights_refugee_global_issues_like_units || 0,
      human_rights_refugee_global_issues_direct_edit_conflicts:
        humanRightsRefugeeGlobalIssuesAudit?.summary
      ...
      footnote_referback_repeated_citation_review_units:
        footnoteReferbackAudit?.summary?.repeated_citation_review_units || 0,
      footnote_referback_direct_edit_conflicts:
        footnoteReferbackAudit?.summary?.direct_footnote_referback_edit_conflicts || 0,
      cross_reference_registry_usages: crossReferenceAudit?.summary?.cross_reference_usages || 0,
      cross_reference_registry_warnings: crossReferenceAudit?.summary?.warnings || 0,
      cross_reference_unmatched_like_units:
        crossReferenceAudit?.summary?.unmatched_cross_reference_like_units || 0,
      cross_reference_incomplete_slug_units:
        crossReferenceAudit?.summary?.incomplete_cross_reference_slug_units || 0,
      cross_reference_direct_edit_conflicts:
        crossReferenceAudit?.summary?.direct_cross_reference_edit_conflicts || 0,
      ...
      annotation_sheet_profile_assembly_warnings:
        annotationSheetProfileAudit?.summary?.assembly_warnings || 0,
      annotation_sheet_profile_missing_page_break_headings:
        annotationSheetProfileAudit?.summary?.document_headings_without_page_break || 0,
      annotation_sheet_profile_heading_note_references:
        annotationSheetProfileAudit?.summary?.heading_note_reference_units || 0,
      annotation_sheet_profile_note_numbering_units:
        annotationSheetProfileAudit?.summary?.note_numbering_units || 0,
    ...
    optional_context: {
      ...
      source_surrogate_registry: options.sourceSurrogateRegistryPath
        ...
        : "",
      document_status_lifecycle_registry: options.documentStatusLifecycleRegistryPath
        ? normalizePathForOutput(options.documentStatusLifecycleRegistryPath)
        : "",
...
function runReview(options) {
  ...
  const artifacts = {
    ...
    document_status_lifecycle_usage_audit: path.join(
      options.artifactDir,
    ...
    editorial_method_registry_validation: path.join(options.artifactDir, "editorial-method-registry-validation.json"),
    editorial_method_usage_audit: path.join(options.artifactDir, "editorial-method-usage-audit.json"),
    ...
    meeting_attendance_registry_validation: path.join(
      options.artifactDir,
      "meeting-attendance-registry-validation.json"
    ),
    meeting_attendance_usage_audit: path.join(options.artifactDir, "meeting-attendance-usage-audit.json"),
    ...
    summit_public_event_registry_validation: path.join(
      options.artifactDir,
      "summit-public-event-registry-validation.json"
    ),
    summit_public_event_usage_audit: path.join(options.artifactDir, "summit-public-event-usage-audit.json"),
    ...
    release_apparatus_registry_validation: path.join(
      options.artifactDir,
      "release-apparatus-registry-validation.json"
    ),
    release_apparatus_usage_audit: path.join(options.artifactDir, "release-apparatus-usage-audit.json"),
    ...
    congressional_legal_registry_validation: path.join(
      options.artifactDir,
      "congressional-legal-registry-validation.json"
    ),
    congressional_legal_usage_audit: path.join(options.artifactDir, "congressional-legal-usage-audit.json"),
    economic_financial_registry_validation: path.join(
      options.artifactDir,
      "economic-financial-registry-validation.json"
    ),
    economic_financial_usage_audit: path.join(options.artifactDir, "economic-financial-usage-audit.json"),
    military_crisis_registry_validation: path.join(
      options.artifactDir,
      "military-crisis-registry-validation.json"
    ),
    military_crisis_usage_audit: path.join(options.artifactDir, "military-crisis-usage-audit.json"),
    intelligence_law_enforcement_registry_validation: path.join(
      options.artifactDir,
      "intelligence-law-enforcement-registry-validation.json"
    ),
    intelligence_law_enforcement_usage_audit: path.join(
      options.artifactDir,
      "intelligence-law-enforcement-usage-audit.json"
    ),
    human_rights_refugee_global_issues_registry_validation: path.join(
      options.artifactDir,
      "human-rights-refugee-global-issues-registry-validation.json"
    ),
    human_rights_refugee_global_issues_usage_audit: path.join(
      options.artifactDir,
    ...
    cross_reference_registry_validation: path.join(options.artifactDir, "cross-reference-registry-validation.json"),
    cross_reference_usage_audit: path.join(options.artifactDir, "cross-reference-usage-audit.json"),
  ...
  if (options.sourceSurrogateRegistryPath) {
    const sourceSurrogateValidationStep = runNodeStep({
      label: "validate_source_surrogate_registry",
      args: [
        "scripts/validate-frus-source-surrogate-registry.mjs",
        "--registry",
        options.sourceSurrogateRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.source_surrogate_registry_validation,
      parseJson: true
    });
    steps.push(sourceSurrogateValidationStep);
    optionalReports.source_surrogate_registry_validation = sourceSurrogateValidationStep.parsed;

    const sourceSurrogateAuditArgs = [
    ...
    if (options.targetVolume) {
      sourceSurrogateAuditArgs.push("--target-volume", options.targetVolume);
    }
    const sourceSurrogateAuditStep = runNodeStep({
      label: "audit_source_surrogate_usage",
      args: sourceSurrogateAuditArgs,
      cwd,
      stdoutFile: artifacts.source_surrogate_usage_audit,
      parseJson: true
    });
    steps.push(sourceSurrogateAuditStep);
    optionalReports.source_surrogate_usage_audit = sourceSurrogateAuditStep.parsed;
  }
  if (options.documentStatusLifecycleRegistryPath) {
    const documentStatusLifecycleValidationStep = runNodeStep({
      label: "validate_document_status_lifecycle_registry",
      args: [
        "scripts/validate-frus-document-status-lifecycle-registry.mjs",
        "--registry",
        options.documentStatusLifecycleRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.document_status_lifecycle_registry_validation,
      parseJson: true
    });
    steps.push(documentStatusLifecycleValidationStep);
    optionalReports.document_status_lifecycle_registry_validation = documentStatusLifecycleValidationStep.parsed;

    const documentStatusLifecycleAuditArgs = [
    ...
    if (options.targetVolume) {
      documentStatusLifecycleAuditArgs.push("--target-volume", options.targetVolume);
    }
    const documentStatusLifecycleAuditStep = runNodeStep({
      label: "audit_document_status_lifecycle_usage",
      args: documentStatusLifecycleAuditArgs,
      cwd,
      stdoutFile: artifacts.document_status_lifecycle_usage_audit,
      parseJson: true
    });
    steps.push(documentStatusLifecycleAuditStep);
    optionalReports.document_status_lifecycle_usage_audit = documentStatusLifecycleAuditStep.parsed;
  }
  ...
  if (options.editorialMethodRegistryPath) {
    const editorialMethodValidationStep = runNodeStep({
      label: "validate_editorial_method_registry",
      args: [
        "scripts/validate-frus-editorial-method-registry.mjs",
        "--registry",
        options.editorialMethodRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.editorial_method_registry_validation,
      parseJson: true
    });
    steps.push(editorialMethodValidationStep);
    optionalReports.editorial_method_registry_validation = editorialMethodValidationStep.parsed;

    const editorialMethodAuditArgs = [
    ...
    if (options.targetVolume) {
      editorialMethodAuditArgs.push("--target-volume", options.targetVolume);
    }
    const editorialMethodAuditStep = runNodeStep({
      label: "audit_editorial_method_usage",
      args: editorialMethodAuditArgs,
      cwd,
      stdoutFile: artifacts.editorial_method_usage_audit,
      parseJson: true
    });
    steps.push(editorialMethodAuditStep);
    optionalReports.editorial_method_usage_audit = editorialMethodAuditStep.parsed;
  }
  ...
  if (options.meetingAttendanceRegistryPath) {
    const meetingAttendanceValidationStep = runNodeStep({
      label: "validate_meeting_attendance_registry",
      args: [
        "scripts/validate-frus-meeting-attendance-registry.mjs",
        "--registry",
        options.meetingAttendanceRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.meeting_attendance_registry_validation,
      parseJson: true
    });
    steps.push(meetingAttendanceValidationStep);
    optionalReports.meeting_attendance_registry_validation = meetingAttendanceValidationStep.parsed;

    const meetingAttendanceAuditArgs = [
    ...
    if (options.targetVolume) {
      meetingAttendanceAuditArgs.push("--target-volume", options.targetVolume);
    }
    const meetingAttendanceAuditStep = runNodeStep({
      label: "audit_meeting_attendance_usage",
      args: meetingAttendanceAuditArgs,
      cwd,
      stdoutFile: artifacts.meeting_attendance_usage_audit,
      parseJson: true
    });
    steps.push(meetingAttendanceAuditStep);
    optionalReports.meeting_attendance_usage_audit = meetingAttendanceAuditStep.parsed;
  }
  ...
  if (options.summitPublicEventRegistryPath) {
    const summitPublicEventValidationStep = runNodeStep({
      label: "validate_summit_public_event_registry",
      args: [
        "scripts/validate-frus-summit-public-event-registry.mjs",
        "--registry",
        options.summitPublicEventRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.summit_public_event_registry_validation,
      parseJson: true
    });
    steps.push(summitPublicEventValidationStep);
    optionalReports.summit_public_event_registry_validation = summitPublicEventValidationStep.parsed;

    const summitPublicEventAuditArgs = [
    ...
    if (options.targetVolume) {
      summitPublicEventAuditArgs.push("--target-volume", options.targetVolume);
    }
    const summitPublicEventAuditStep = runNodeStep({
      label: "audit_summit_public_event_usage",
      args: summitPublicEventAuditArgs,
      cwd,
      stdoutFile: artifacts.summit_public_event_usage_audit,
      parseJson: true
    });
    steps.push(summitPublicEventAuditStep);
    optionalReports.summit_public_event_usage_audit = summitPublicEventAuditStep.parsed;
  }
  ...
  if (options.releaseApparatusRegistryPath) {
    const releaseApparatusValidationStep = runNodeStep({
      label: "validate_release_apparatus_registry",
      args: [
        "scripts/validate-frus-release-apparatus-registry.mjs",
        "--registry",
        options.releaseApparatusRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.release_apparatus_registry_validation,
      parseJson: true
    });
    steps.push(releaseApparatusValidationStep);
    optionalReports.release_apparatus_registry_validation = releaseApparatusValidationStep.parsed;

    const releaseApparatusAuditArgs = [
    ...
    if (options.targetVolume) {
      releaseApparatusAuditArgs.push("--target-volume", options.targetVolume);
    }
    const releaseApparatusAuditStep = runNodeStep({
      label: "audit_release_apparatus_usage",
      args: releaseApparatusAuditArgs,
      cwd,
      stdoutFile: artifacts.release_apparatus_usage_audit,
      parseJson: true
    });
    steps.push(releaseApparatusAuditStep);
    optionalReports.release_apparatus_usage_audit = releaseApparatusAuditStep.parsed;
  }
  ...
  if (options.congressionalLegalRegistryPath) {
    const congressionalLegalValidationStep = runNodeStep({
      label: "validate_congressional_legal_registry",
      args: [
        "scripts/validate-frus-congressional-legal-registry.mjs",
        "--registry",
        options.congressionalLegalRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.congressional_legal_registry_validation,
      parseJson: true
    });
    steps.push(congressionalLegalValidationStep);
    optionalReports.congressional_legal_registry_validation = congressionalLegalValidationStep.parsed;

    const congressionalLegalAuditArgs = [
    ...
    if (options.targetVolume) {
      congressionalLegalAuditArgs.push("--target-volume", options.targetVolume);
    }
    const congressionalLegalAuditStep = runNodeStep({
      label: "audit_congressional_legal_usage",
      args: congressionalLegalAuditArgs,
      cwd,
      stdoutFile: artifacts.congressional_legal_usage_audit,
      parseJson: true
    });
    steps.push(congressionalLegalAuditStep);
    optionalReports.congressional_legal_usage_audit = congressionalLegalAuditStep.parsed;
  }
  if (options.economicFinancialRegistryPath) {
    const economicFinancialValidationStep = runNodeStep({
      label: "validate_economic_financial_registry",
      args: [
        "scripts/validate-frus-economic-financial-registry.mjs",
        "--registry",
        options.economicFinancialRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.economic_financial_registry_validation,
      parseJson: true
    });
    steps.push(economicFinancialValidationStep);
    optionalReports.economic_financial_registry_validation = economicFinancialValidationStep.parsed;

    const economicFinancialAuditArgs = [
    ...
    if (options.targetVolume) {
      economicFinancialAuditArgs.push("--target-volume", options.targetVolume);
    }
    const economicFinancialAuditStep = runNodeStep({
      label: "audit_economic_financial_usage",
      args: economicFinancialAuditArgs,
      cwd,
      stdoutFile: artifacts.economic_financial_usage_audit,
      parseJson: true
    });
    steps.push(economicFinancialAuditStep);
    optionalReports.economic_financial_usage_audit = economicFinancialAuditStep.parsed;
  }
  if (options.militaryCrisisRegistryPath) {
    const militaryCrisisValidationStep = runNodeStep({
      label: "validate_military_crisis_registry",
      args: [
        "scripts/validate-frus-military-crisis-registry.mjs",
        "--registry",
        options.militaryCrisisRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.military_crisis_registry_validation,
      parseJson: true
    });
    steps.push(militaryCrisisValidationStep);
    optionalReports.military_crisis_registry_validation = militaryCrisisValidationStep.parsed;

    const militaryCrisisAuditArgs = [
    ...
    if (options.targetVolume) {
      militaryCrisisAuditArgs.push("--target-volume", options.targetVolume);
    }
    const militaryCrisisAuditStep = runNodeStep({
      label: "audit_military_crisis_usage",
      args: militaryCrisisAuditArgs,
      cwd,
      stdoutFile: artifacts.military_crisis_usage_audit,
      parseJson: true
    });
    steps.push(militaryCrisisAuditStep);
    optionalReports.military_crisis_usage_audit = militaryCrisisAuditStep.parsed;
  }
  if (options.intelligenceLawEnforcementRegistryPath) {
    const intelligenceLawEnforcementValidationStep = runNodeStep({
      label: "validate_intelligence_law_enforcement_registry",
      args: [
        "scripts/validate-frus-intelligence-law-enforcement-registry.mjs",
        "--registry",
        options.intelligenceLawEnforcementRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.intelligence_law_enforcement_registry_validation,
      parseJson: true
    });
    steps.push(intelligenceLawEnforcementValidationStep);
    optionalReports.intelligence_law_enforcement_registry_validation =
      intelligenceLawEnforcementValidationStep.parsed;

    const intelligenceLawEnforcementAuditArgs = [
    ...
    if (options.targetVolume) {
      intelligenceLawEnforcementAuditArgs.push("--target-volume", options.targetVolume);
    }
    const intelligenceLawEnforcementAuditStep = runNodeStep({
      label: "audit_intelligence_law_enforcement_usage",
      args: intelligenceLawEnforcementAuditArgs,
      cwd,
      stdoutFile: artifacts.intelligence_law_enforcement_usage_audit,
      parseJson: true
    });
    steps.push(intelligenceLawEnforcementAuditStep);
    optionalReports.intelligence_law_enforcement_usage_audit = intelligenceLawEnforcementAuditStep.parsed;
  }
  if (options.humanRightsRefugeeGlobalIssuesRegistryPath) {
    const humanRightsRefugeeGlobalIssuesValidationStep = runNodeStep({
      label: "validate_human_rights_refugee_global_issues_registry",
      args: [
      ...
      cwd,
      stdoutFile: artifacts.human_rights_refugee_global_issues_registry_validation,
      parseJson: true
    });
    steps.push(humanRightsRefugeeGlobalIssuesValidationStep);
    optionalReports.human_rights_refugee_global_issues_registry_validation =
      humanRightsRefugeeGlobalIssuesValidationStep.parsed;

    const humanRightsRefugeeGlobalIssuesAuditArgs = [
    ...
    if (options.targetVolume) {
      humanRightsRefugeeGlobalIssuesAuditArgs.push("--target-volume", options.targetVolume);
    }
    const humanRightsRefugeeGlobalIssuesAuditStep = runNodeStep({
      label: "audit_human_rights_refugee_global_issues_usage",
      args: humanRightsRefugeeGlobalIssuesAuditArgs,
      cwd,
      stdoutFile: artifacts.human_rights_refugee_global_issues_usage_audit,
      parseJson: true
    });
    steps.push(humanRightsRefugeeGlobalIssuesAuditStep);
    optionalReports.human_rights_refugee_global_issues_usage_audit =
      humanRightsRefugeeGlobalIssuesAuditStep.parsed;
  }
  ...
  if (options.crossReferenceRegistryPath) {
    const crossReferenceValidationStep = runNodeStep({
      label: "validate_cross_reference_registry",
      args: [
        "scripts/validate-frus-cross-reference-registry.mjs",
        "--registry",
        options.crossReferenceRegistryPath,
        "--format",
        "json"
      ],
      cwd,
      stdoutFile: artifacts.cross_reference_registry_validation,
      parseJson: true
    });
    steps.push(crossReferenceValidationStep);
    optionalReports.cross_reference_registry_validation = crossReferenceValidationStep.parsed;

    const crossReferenceAuditArgs = [
    ...
    if (options.targetVolume) {
      crossReferenceAuditArgs.push("--target-volume", options.targetVolume);
    }
    const crossReferenceAuditStep = runNodeStep({
      label: "audit_cross_reference_usage",
      args: crossReferenceAuditArgs,
      cwd,
      stdoutFile: artifacts.cross_reference_usage_audit,
      parseJson: true
    });
    steps.push(crossReferenceAuditStep);
    optionalReports.cross_reference_usage_audit = crossReferenceAuditStep.parsed;
  }
