...
19. Run treaty/legal-instrument validation and usage audit when source notes,
...
20. Run foreign/international-organization validation and usage audit when
...
21. Run recurring compiler-risk validation and usage audit on every annotation
...
22. Run negative-search/no-record validation and usage audit when source notes,
...
23. Run document-relationship validation and usage audit when source notes,
   follow-on footnotes, editorial notes, or attachment notes contain
...
24. Run communications validation and usage audit when source notes, follow-on
...
25. Run source-note and production-marker checks when those unit types are
   present:
